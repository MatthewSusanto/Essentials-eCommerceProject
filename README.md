...
- **Difficulty:** Dealing with the dynamic data of my components  <br />
 ...
 **Solution:** Learned how to optimize the performance of the application such as changing the type of the images
